...
import { Transaction, TransactionOptions, IsolationLevel, TransactionError, generateUUID, QueryParams, QueryOptions, QueryResult } from '@db-bridge/core';
...
export class MySQLTransaction implements Transaction {
   ...
   */
  async execute<T = unknown>(sql: string, params?: QueryParams, options?: QueryOptions): Promise<QueryResult<T>> {
