...
export type { StreamEntry, StreamInfo, ConsumerGroupInfo } from './streams/modular-stream-manager';

// Re-export core interfaces
export type { CacheAdapter, ConnectionConfig, DatabaseAdapter } from '@db-bridge/core';
