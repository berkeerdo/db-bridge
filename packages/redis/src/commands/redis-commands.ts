...
export class RedisCommands {
  ...
  async hmset(key: string, data: Record<string, string>): Promise<string> {
    const result = await this.client.hmset(
      this.adapter.getFullKey(key),
      data,
    );
    return result;
  ...
  async lpush(key: string, ...values: string[]): Promise<number> {
    const result = await this.client.lpush(
      this.adapter.getFullKey(key),
      ...values,
    );
    return result;
  ...
  async lpop(key: string): Promise<string | null> {
    const result = await this.client.lpop(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async rpop(key: string): Promise<string | null> {
    const result = await this.client.rpop(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async lrange(key: string, start: number, stop: number): Promise<string[]> {
    const result = await this.client.lrange(
      this.adapter.getFullKey(key),
      start,
      stop,
    );
  ...
  async llen(key: string): Promise<number> {
    const result = await this.client.llen(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async sadd(key: string, ...members: string[]): Promise<number> {
    const result = await this.client.sadd(
      this.adapter.getFullKey(key),
      ...members,
    );
    return result;
  ...
  async srem(key: string, ...members: string[]): Promise<number> {
    const result = await this.client.srem(
      this.adapter.getFullKey(key),
      ...members,
    );
    return result;
  ...
  async smembers(key: string): Promise<string[]> {
    const result = await this.client.smembers(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async scard(key: string): Promise<number> {
    const result = await this.client.scard(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async zrem(key: string, ...members: string[]): Promise<number> {
    const result = await this.client.zrem(
      this.adapter.getFullKey(key),
      ...members,
    );
    return result;
  ...
  async zcard(key: string): Promise<number> {
    const result = await this.client.zcard(
      this.adapter.getFullKey(key),
    );
    return result;
  }
  ...
  async subscribe(channels: string[], callback: (channel: string, message: string) => void): Promise<void> {
    ...
    await subscriber.on('message', callback);
